  ...
  return (
    <div className="card mb-4 shadow-sm">
      ...
      <div className="card-footer text-muted">
        Showing {filteredData.length} of {data.length} teams.
      </div>

      <div className="modal fade" id="teamsDetailsModal" tabIndex="-1" aria-labelledby="teamsDetailsModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-lg modal-dialog-scrollable">
          <div className="modal-content">
            ...
            <div className="modal-body">
              {activeItem ? <pre>{JSON.stringify(activeItem, null, 2)}</pre> : <p>No team selected.</p>}
            </div>
