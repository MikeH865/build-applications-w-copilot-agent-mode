  ...
  return (
    <div className="card mb-4 shadow-sm">
      ...
      <div className="card-body">
        ...
        {loading ? (
          ...
          <div className="alert alert-info" role="alert">
            No teams found. <button type="button" className="btn btn-sm btn-info" onClick={fetchData}>Retry</button>
          </div>
        ) : (
          <>
                    ...
                    <tr key={item.id || index}>
                      ...
                      <td className="text-center">
                        <button
                          ...
                          data-bs-target="#teamsDetailsModal"
            ...
            <div className="card-footer text-muted text-center py-3">
              Showing <strong>{filteredData.length}</strong> of <strong>{data.length}</strong> teams
            </div>
          </>
        )}
      </div>
      ...
      <div
        ...
        id="teamsDetailsModal"
        tabIndex="-1"
        aria-labelledby="teamsDetailsModalLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="teamsDetailsModalLabel">
                Team Details
              </h5>
              <button
                type="button"
            ...
            <div className="modal-body">
              {activeItem ? (
                <>
                  <h6 className="mb-3">Team Information</h6>
