  ...
  return (
    <div className="card mb-4 shadow-sm">
      ...
      <div className="card-body">
        ...
        {loading ? (
          ...
          <div className="alert alert-info" role="alert">
            No users found. <button type="button" className="btn btn-sm btn-info" onClick={fetchData}>Retry</button>
          </div>
        ) : (
          <>
                    ...
                    <tr key={item.id || index}>
                      ...
                      <td className="text-center">
                        <button
                          ...
                          data-bs-target="#usersDetailsModal"
            ...
            <div className="card-footer text-muted text-center py-3">
              Showing <strong>{filteredData.length}</strong> of <strong>{data.length}</strong> users
            </div>
          </>
        )}
      </div>
      ...
      <div
        ...
        id="usersDetailsModal"
        tabIndex="-1"
        aria-labelledby="usersDetailsModalLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="usersDetailsModalLabel">
                User Details
              </h5>
              <button
                type="button"
