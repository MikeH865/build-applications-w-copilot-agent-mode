...
function Users() {
  ...
  return (
    <div className="card mb-4 shadow-sm">
      ...
      <div className="modal fade" id="usersDetailsModal" tabIndex="-1" aria-labelledby="usersDetailsModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-lg modal-dialog-scrollable">
          <div className="modal-content">
            ...
            <div className="modal-body">
              {activeItem ? <pre>{JSON.stringify(activeItem, null, 2)}</pre> : <p>No user selected.</p>}
            </div>
